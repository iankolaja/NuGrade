...
class MetricOptions:
    def __init__(self):
        ...
        self.scored_metric = ""
        self.projectile = ""
        self.energy_coverage_scale = "log"
    ...
    def get_metric_text(self):
        ...
        return metric_text_dict[self.scored_metric]
    ...
    def gen_html_description(self, do_html=True):
        ...
        lower_energy_str = np.format_float_scientific(self.lower_energy, precision=4,exp_digits=1,unique=True, min_digits=2)
        upper_energy_str = np.format_float_scientific(self.upper_energy, precision=4,exp_digits=1,unique=True, min_digits=2)
        if do_html:
            param_text = f"""
